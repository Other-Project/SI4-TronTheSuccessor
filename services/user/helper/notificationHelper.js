 ...
 */
exports.sendNotification = async function (username, authorization) {
    return makeHttpRequest(new URL(process.env.NOTIFICATION_SERVICE_URL || "http://localhost:8005"), 'POST', `api/notification/friend`, authorization, {username: username});
};
